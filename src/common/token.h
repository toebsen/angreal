...
struct Token {
  ...
  static std::string type2str(Type t) { return std::string(magic_enum::enum_name(t)); };

  struct Position {
    int line;
  };

  Token(const std::string &value, tb_lang::State finalState, const Position &pos)
  ...
  friend std::ostream &operator<<(std::ostream &os, const tb_lang::Token &tok) {
    os << "Token(" << magic_enum::enum_name(tok.type()) << ", '" << tok.value() << "'";
    os << " Line: " << tok.position().line << ")";
    return os;
  }

  static Token::Type infer(const std::string &value, const tb_lang::State &finalSate) {
    switch (finalSate) {
      case tb_lang::State::Digit:return Type::Integer;
      case tb_lang::State::DigitPeriod:return Type::Float;
      case tb_lang::State::AddSub:return Type::AdditiveOp;
      case tb_lang::State::Asterisk:return Type::MulOp;
      case tb_lang::State::Slash:return Type::DivOp;
      case tb_lang::State::EndComment:return Type::Comment;
      case tb_lang::State::Identifier:if (value == "true" || value == "false") return Type::Boolean;
      ...
      case tb_lang::State::EndString:return Type::String;
      case tb_lang::State::Equals:return Type::Equal;
      case tb_lang::State::Exclamation:return Type::Exclamation;
      case tb_lang::State::Punctuation:if (value == "{") return Type::LeftCurlyBracket;
      ...
      case tb_lang::State::CombinedRelational:return Type::RelationalOp;
      case tb_lang::State::NewLine:return Type::NewLine;
      case tb_lang::State::EndOfProgram:return Type::EndOfProgram;
      case State::Invalid:
      case State::Initial:
      case State::Period:
      case State::StartComment:
      case State::StartString:
      case State::WhiteSpace:return Type::Error;
    }
    return Type::Error;
  }
