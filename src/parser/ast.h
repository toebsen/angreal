...
namespace tb_lang::parser::AST
{
    ...
    public:
        ...
        static TypeSystem::Type type()
        { return TypeSystem::Type::Unknown; };
    ...
    public:
        ...
        FunctionDeclaration(const TypeSystem::Type &type, const std::string &identifier, const formal_parameters& parameters, statements_t statements)
