...
protected:
  ...
  std::shared_ptr<AST::Expression> parseTypeLiteral(TypeSystem::Type expected);
  ...
  void expectToken(const std::string &description, std::function<bool(Token::Type t)> predicate);
