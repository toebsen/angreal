...
protected:
    ...
    void lexSequence(const std::vector<std::string> &vals, const tokens_t &expected)
    {
    ...
    void lexSequence(const std::vector<std::string> &vals, const Token::Type &expected)
    {
        const tokens_t tokens(vals.size(), expected);
        lexSequence(vals, tokens);
    }

    void lexProgram(const std::string &program, const std::vector<Token> &expected)
    {
...
TEST_F(LexerTest, ProgramWithFloat)
{
    ...
    lexSequence({"1.2", "1234.56789", "56789.1234", ".09", ".09"}, Token::Type::Float);
}
...
{
    lexSequence(
            {"if", "def", "var", "set", "return", "while", "for", "print", "and", "or", "not", "int", "float", "bool",
             "string"},
            {Token::Type::IfStatement, Token::Type::DefStatement, Token::Type::VarStatement,
             Token::Type::SetStatement, Token::Type::ReturnStatement, Token::Type::WhileStatement,
             Token::Type::ForStatement, Token::Type::PrintStatement, Token::Type::AndStatement,
             Token::Type::OrStatement,
             Token::Type::NotStatement, Token::Type::IntIdentifier, Token::Type::FloatIdentifier,
...
TEST_F(LexerTest, Punctuation)
{
    ...
    std::vector<Token::Type> tokens = {Token::Type::LeftCurlyBracket, Token::Type::RightCurlyBracket,
                                       Token::Type::LeftBracket, Token::Type::RightBracket, Token::Type::Comma,
                                       Token::Type::Colon,
